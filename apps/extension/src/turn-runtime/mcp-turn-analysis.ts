...
export interface ParseResult<TBlock extends ParsedMcpCandidate = ParsedMcpCandidate> {
  blocks: TBlock[];
  errors: string[];
}

export interface McpTurnAnalysis<TBlock extends ParsedMcpCandidate = ParsedMcpCandidate> extends ParseResult<TBlock> {
